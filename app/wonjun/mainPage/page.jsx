		...
		<>
				...
				<div className={styles.infocardWrapper}>
					<div className={styles.infoCard}>
						...
						<div className={styles.infoContent}>
							...
							<h3>이용시간</h3>
							<p>월~토: 24시간 운영<br />일요일: 09:00 ~ 18:00</p>
						</div>
				...
				<div className={styles.introSection}>
					<div className={styles.introContent}>
						...
						<p className={styles.introText}>
							포근하고 넓은 마음으로 쉼을 주는 느티나무와 같이, 장애인 이용자들에게 사랑과 쉼을 주는 즐거운 집이 되기 위해 만들어졌습니다.
						</p>
						<p className={styles.introText}>
							가정에서 일시적으로 생활이 어려운 장애인에게 일정기간 동안 휴식, 요양, 보호를 위한 거주 공간 및 일상생활 서비스를 제공하여 가족 구성원이 안심하고 사회, 경제적 활동을 영위할 수 있도록 월-토요일 12시까지 24시간 운영하는 시설입니다.
						</p>
					</div>
			...
			<section className={styles.noticeSection}>
				<div className={styles.noticeHeader}>
					...
					<a className={styles.noticeMore} href="#">
						전체보기 
						<Image className={styles.noticeArrow} src="/images/arrow.png" width={20} height={20} alt="화살표"/>
					</a>
				</div>

				<div className={styles.noticeList}>
					{[
						{ day: "15", month: "7월", title: "2023 하반기 이용 안내", desc: "하반기 이용 관련 안내사항을 알려드립니다." },
						{ day: "28", month: "6월", title: "여름철 시설 이용 주의사항", desc: "더운 여름철 시설 이용 시 주의해주실 사항을 안내드립니다." },
						{ day: "10", month: "6월", title: "휴관일 안내 (6월 12일)", desc: "6월 12일은 시설 휴관일임을 알려드립니다." },
					].map((item, i) => (
			...
			<section className={styles.facilitySection}>
				<div className={styles.facilityHeader}>
					...
					전체보기
					<Image className={styles.facilityArrow} src="/images/arrow.png" width={20} height={20} alt="화살표" />
					</a>
				</div>
